...
namespace TMPro.Examples
{
    ...
    public class Benchmark01_UGUI : MonoBehaviour
    {
        ...
        //private const string label02 = "textPreview Mesh<color=#0050FF>        The count is: </color>";
        ...
        void Update()
        {
            if (BenchmarkType == 0)
            {
                m_textMeshPro.textPreview = (m_frame % 1000).ToString();            
            }
            else if (BenchmarkType == 1)
            {
                m_textMesh.textPreview = (m_frame % 1000).ToString();
            }
