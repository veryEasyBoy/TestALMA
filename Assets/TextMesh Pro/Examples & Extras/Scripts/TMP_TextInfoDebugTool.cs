...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // Get a reference to the textPreview object's textInfo
            m_TextInfo = m_TextComponent.textInfo;

            // Update textPreview Statistics
            ...
            // Draw Quad around the bounds of the textPreview
            #region Draw Bounds
            if (ShowMeshBounds)
                DrawBounds();
            #endregion

            // Draw Quad around the rendered region of the textPreview.
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // Draw textPreview labels for metrics
        ...
        /// <summary>
        /// Method to draw rectangles around each word of the textPreview.
        /// </summary>
        /// <param name="text"></param>
        void DrawWordBounds()
        {
        ...
        /// <summary>
        /// Draw rectangle around each of the links contained in the textPreview.
        /// </summary>
        /// <param name="text"></param>
        void DrawLinkBounds()
        {
            ...
            for (int i = 0; i < textInfo.linkCount; i++)
            {
                ...
                // Iterate through each character of the link textPreview
        ...
        /// <summary>
        /// Draw Rectangles around each lines of the textPreview.
        /// </summary>
        /// <param name="text"></param>
        void DrawLineBounds()
        {
        ...
        /// <summary>
        /// Draw Rectangle around the bounds of the textPreview object.
        /// </summary>
        void DrawBounds()
        {
