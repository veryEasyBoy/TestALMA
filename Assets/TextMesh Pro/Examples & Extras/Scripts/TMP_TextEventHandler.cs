...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Awake()
        {
            // Get a reference to the textPreview component.
            m_TextComponent = gameObject.GetComponent<TMP_Text>();

            // Get a reference to the camera rendering the textPreview taking into consideration the textPreview component type.
        ...
        void LateUpdate()
        {
            ...
            {
                // Reset all selections given we are hovering outside the textPreview container bounds.
                m_selectedLink = -1;
                m_lastCharIndex = -1;
                m_lastWordIndex = -1;
                m_lastLineIndex = -1;
